...
/** Reload BOTH stores for the newly-active account and drop any armed upload.
 *  Missing the collapsed-groups store would leave one account's collapse state
 *  applied to another's sidebar. */
